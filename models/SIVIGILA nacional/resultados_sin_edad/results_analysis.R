...
# Leer stanfit
SIVIGILA_model  <- readRDS(file.path(here(),"models","SIVIGILA nacional","resultados_sin_edad","SIVIGILA_model_sinedad.rds"))
stan_array <- as.array(SIVIGILA_model)

# Extraer muestras
posterior_samples <- readRDS(file.path(here(),"models","SIVIGILA nacional","resultados_sin_edad","posterior_sample_SIVIGILA_sinedad.rds"))
