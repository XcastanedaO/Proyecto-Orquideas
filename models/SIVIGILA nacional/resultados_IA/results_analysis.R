...
# Leer stanfit
SIVIGILA_model  <- readRDS(file.path(here(),"models","SIVIGILA nacional","resultados_IA","SIVIGILA_model.rds"))
stan_array <- as.array(SIVIGILA_model)

# Extraer muestras
posterior_samples <- readRDS(file.path(here(),"models","SIVIGILA nacional","resultados_IA","posterior_sample_SIVIGILA.rds"))
