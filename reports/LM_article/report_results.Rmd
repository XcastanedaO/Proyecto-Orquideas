...
***Tabla 1.** Resultados de las pruebas de asociación entre variables cualitativas y la atención en salud.*

En la **Tabla 1** se presentan estas variables ordenadas de mayor a menor según el valor del coeficiente de Cramér. Para cada una se indica la prueba estadística aplicada, el valor del estadístico y su valor-p correspondiente. A continuación, se describen estas variables y su composición en la base de datos analizada:
