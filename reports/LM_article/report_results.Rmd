...
A continuación, se presentan los resultados obtenidos del modelo:
```{r, echo=FALSE, warning=FALSE, message= FALSE}
...
Entre mujeres con características similares, aquellas que son cabeza de familia son un 60% más propensas a recibir atención en salud mental que las que no lo son y vivir en un centro poblado o en zona rural dispersa se asocia con una mayor probabilidad relativa de atención del 78% y 80%, respectivamente, en comparación con vivir en una cabecera municipal. De forma similar, haber sido agredida en un espacio público o social con un 41% más de probabilidad relativa en relación con quienes fueron agredidas en su vivienda. 
...
**LAS SIGUIENTES SON LAS VARIABLES QUE NO DIERON SIGNIFICATIVAS EN EL PRIMER MODELO**
[8] "sexo_agreF"                                               
 [9] "sexo_agreM"                                               
[10] "parentezco_agresorPareja"                                 
[11] "parentezco_agresorFamiliar"                               
[12] "parentezco_agresorEx_Pareja"                              
[13] "parentezco_agresorPadre" 
[19] "pac_hos_1" 
[21] "escenarioComercio y áreas de servicios"                   
[22] "escenarioEspacios abiertos"                               
[23] "escenarioEstablecimiento educativo"      
[27] "escenarioVía Pública"                                     
[28] "escenarioVivienda"