...
# Cambiar nombres de las categorías
...
# Calcular ancho del intervalo de confianza
...
```
Ahora bien, este modelo obtuvo un **AUC de** `r auc(roc_obj)`, menor al modelo anterior. Este resultado brinda la oportunidad de plantear nuevos modelos que logren captar más ampliamente la dinámica del contexto. 