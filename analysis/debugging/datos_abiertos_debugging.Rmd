...
Se eliminan las siguientes variables por considerar que no aportan información útil al estudio
...
data <- data %>%
  mutate(
    ...
    Barrio = str_to_title(tolower(Barrio))
  )
```
...
data <- data %>%
  mutate(
    ...
    Comuna = str_to_title(tolower(Comuna)),
    Comuna = case_when(
    ...
    naturaleza = case_when(
      ...
      (is.na(naturaleza) |
         naturaleza == "") & def_naturaleza == "Psicológica" ~ "2",
            (is.na(naturaleza) |
         naturaleza == "") & def_naturaleza == "Abuso sexual" ~ "4",
      (is.na(naturaleza) |
         naturaleza == "") & def_naturaleza == "Actos sexuales violencia" ~ "12",
      (is.na(naturaleza) |
         naturaleza == "") & def_naturaleza == "Violación" ~ "6",
            (is.na(naturaleza) |
         naturaleza == "") & def_naturaleza == "Explotacion sexual, comercial niños, adolescentes" ~ "7",
                  (is.na(naturaleza) |
         naturaleza == "") & def_naturaleza == "Otros actos sexuales" ~ "14",
      TRUE ~ naturaleza
    )
  )
